  ...
  return (
    <GalleryShell>
      <main className="section-shell py-16 lg:py-24">
        <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-end"><div><p className="eyebrow">Seller studio</p><h1 className="mt-5 font-serif text-5xl tracking-[-.05em] sm:text-6xl">Your marketplace workspace</h1><p className="mt-3 text-white/50">Welcome back, {snapshot.artist.displayName}. Manage inventory, fulfillment, and verified earnings.</p></div><div className="flex flex-wrap gap-3"><Link href="/seller/artworks/new" className="button-light">Add artwork</Link>{auctionsEnabled() && <Link href="/seller/auctions" className="button-outline">Auction studio</Link>}</div></div>
